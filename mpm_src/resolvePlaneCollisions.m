...
for node_num = 1:total_node_num
    ...
    node_idx = [mod(node_num,physics_grid.num_grid_nodes(1)) ...
        mod(node_num/physics_grid.num_grid_nodes(1), physics_grid.num_grid_nodes(2))...
        floor(node_num/(physics_grid.num_grid_nodes(1)*physics_grid.num_grid_nodes(2)))];
    node_coord = node_idx * physics_grid.delta;
