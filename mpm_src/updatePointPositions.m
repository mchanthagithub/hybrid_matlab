function [ mpm_points ] = updatePointPositions( physics_grid,mpm_points,basis_functions, del_t)
        ...
        for z_idx = grid_idx(3):grid_idx(3)+1
            for y_idx = grid_idx(2):grid_idx(2)+1
                for x_idx = grid_idx(1):grid_idx(1)+1
                    ...
                    vel = vel + basis_weight*physics_grid.rasterized_velocity(grid_flat_idx,:);
                end
            end
        end
        mpm_points.q(pt_num,:) = mpm_points.q(pt_num,:) + del_t*vel;
    end
